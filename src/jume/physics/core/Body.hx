...
class Body {
  ...
  public var collidingWith(default, null): Array<Body> = [];
  public var wasCollidingWith(default, null): Array<Body> = [];
  public var triggeredBy(default, null): Array<Body> = [];
  public var wasTriggeredBy(default, null): Array<Body> = [];
